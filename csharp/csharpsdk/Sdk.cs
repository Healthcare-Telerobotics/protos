...
namespace Telerotobics.SDK
{
    public partial class Sdk
    {
        ...
        public static event Action<ElectricalSignalData[]> OnElectricalSignalsEvent;
        ...
        unsafe private static bool HandleGetFrame(byte* buffer, int* bufferSizePtr)
        {
            ...
            {
                frame.NullableRobotControllerData = new NullableRobotControllerData
                {
                    Data = robotControllerData
                };
            }
